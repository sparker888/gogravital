        ...
        <div className="px-8 py-8">
          <div className="grid items-start justify-center gap-8">
            <div className="group relative">
              <div className="animate-tilt group-hover:duration-50 absolute -inset-4 rounded-lg bg-gradient-to-r from-pink-600 to-sky-600 opacity-60 blur transition duration-1000 group-hover:opacity-100"></div>
